      ...
      <div class="pb-4 bg-white dark:bg-gray-900">
        ...
        <div class="flex justify-between mt-20">
          ...
          <div class="flex">
            ...
            <!-- Save Button -->
            <button data-modal-target="popup-modal" data-modal-toggle="popup-modal" @click="saveNationalId"
              ...
              <div class="relative w-full max-w-md max-h-full">
                <div class="relative bg-white rounded-lg shadow ">
                  ...
                  <div class="p-6 text-center">
                    ...
                    <button onclick="history.go(0)" data-modal-hide="popup-modal" type="button"
  ...
  methods: {
    saveNationalId() {
      ...
      if (this.isNationalIdValid) {
        // Valid nationalId, you can save it to your component's state or take further actions
        this.storedNationalId = this.nationalId;
        console.log('Valid National ID:', this.nationalId);
      } else {
        // Invalid nationalId, you can display an error message or take appropriate action
