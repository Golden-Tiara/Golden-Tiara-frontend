  ...
  <section class="max-w-7xl mx-auto p-0">
    <div class="relative overflow-x-auto">
      ...
      >
        ...
        <tbody>
          <tr
            class="bg-white border-b border-gold hover:bg-gray-50"
            v-for="pawn of paginatedPawns"
            :key="pawn.id"
          >
            <td
              scope="row"
              class="py-4 text-center font-medium text-gray-900 whitespace-nowrap"
            >
            ...
            <td class="py-4 text-center text-blue-500">
              <nuxt-link :to="`/pawn/${pawn.id}`"
                >{{
                  new Date(pawn.contract_date).toLocaleDateString(
                    "th-TH",
                    {
                      year: "numeric",
                      month: "2-digit",
            ...
            <td class="py-4 text-center text-purple-500">
              <nuxt-link :to="`/pawn/${pawn.id}`">{{
                  new Date(pawn.expiry_date).toLocaleDateString(
                    "th-TH",
                    {
                      year: "numeric",
                      month: "2-digit",
