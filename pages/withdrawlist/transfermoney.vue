<template>
    <div class="min-w-screen min-h-screen flex items-center justify-center px-5 py-5">
      <div class="max-w-7xl mx-auto px-10">
        <div class="bg-gray-100 text-gray-500 rounded-3xl border border-gold shadow-xl w-full overflow-hidden">
          <div class="md:flex w-full mr-40">
            <div class="hidden md:block w-1/2 bg-gray-400 py-10 px-10">
              <svg xmlns="http://www.w3.org/2000/svg" width="400" height="auto" viewBox="0 0 564.46765 449.26526"
                ...
                <path
                  ...
                  fill="#3f3d56" />
                <rect x="225.91708" y="79" width="211" height="7" rx="3.5" ry="3.5" fill="#d2ac47" />
                <g>
                  <g>
                    <polygon
                    ...
                    <path
                      ...
                      fill="#d2ac47" />
                    <ellipse cx="91.85157" cy="241.9309" rx="7.21689" ry="12.15477"
                      transform="translate(-66.97226 37.62166) rotate(-17.07063)" fill="#a0616a" />
                  </g>
                  <g>
                    <polygon
                  ...
                  <g>
                    ...
                    <path
                      ...
                      fill="#d2ac47" />
                    <ellipse cx="203.08656" cy="35.81018" rx="12.15477" ry="7.21689"
                      transform="translate(109.01967 219.32569) rotate(-72.86125)" fill="#a0616a" />
                  </g>
                  <path
            ...
            <div class="w-full md:w-1/2 py-10 px-5 md:px-10">
              ...
              <div class="flex -mx-3">
                <div class="w-full px-3 mb-12">
                  <div class="relative z-0 w-full mb-6 group">
                    <input v-model="amountID" type="number"
                      class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                      placeholder=" " required />
              ...
              <div class="flex -mx-3">
                <div class="w-full px-3 mb-12">
                  <div class="relative z-0 w-full mb-6 group">
                    <input v-model="examinationId" type="number"
                      class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                      placeholder=" " required />
                    <label for="examinationId"
                      class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">
    ...
    methods: {
      ...
      async getExamination() {
        try {
          ...
          const response = await fetch(`http://localhost/api/examination/check/${this.examinationId}`);
          if (!response.ok) {
      ...
      async checkData() {
        ...
        try {
          const { data: examination } = await useMyFetch(`examination/check/${this.examinationId}`, {});
      ...
      storeData() {
        ...
        window.location.href = '/transaction/update'
      },
    },
  };
  </script>
