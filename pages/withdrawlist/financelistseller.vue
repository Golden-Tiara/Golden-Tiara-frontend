<template>
  <div class="max-w-7xl mx-auto px-10 mt-20">
    ...
    <div class="overflow-x-auto">
      <table
        class="w-full text-left border-collapse border border-gold rounded-lg"
      >
        <thead>
          <tr>
           <th v-for="field in fields" :key="field.key" @click="sortTable(field.key)" class="border border-red-500 py-3 bg-gold-100 text-center font-semibold">
          {{ field.label }}
          <img
        ...
        <tbody>
          <tr
            ...
            class="border text-center border-gold hover:bg-gray-100"
          >
    ...
    <div class="pagination mt-4 flex">
      <button
        @click="page--"
        :disabled="page <= 1"
        class="mr-2 bg-gold1-400 text-white px-4 py-2 rounded disabled:bg-gold1-300 disabled:text-black disabled:cursor-not-allowed"
      >
        Prev
      </button>
      <button
        ...
        class="bg-gold1-400 text-white px-4 py-2 rounded disabled:bg-gold1-300 disabled:text-black disabled:cursor-not-allowed"
      >
        Next
      </button>
    </div>
