        ...
        <form @submit.prevent="submit">
          <div id="input" class="flex flex-col w-full my-5">
            ...
            <input
              ...
              class="appearance-none border-2 border-gold rounded-lg px-4 py-3 placeholder-gray-300 focus:outline-none focus:ring-2 focus:ring-gold"
            />
          ...
          <div id="button" class="flex flex-col w-full my-5">
            <button
              type="submit"
              class="w-full text-white bg-darkblue font-medium rounded-lg text-sm px-5 py-2.5 text-center hover:bg-gradient-to-b from-gold to-darkgold focus:ring-2 focus:ring-gold focus:outline-none rounded-lg"
            >
              เข้าสู่ระบบ
            </button>
