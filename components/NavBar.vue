        ...
        >
          <li>
            <MenuLink
              ...
              class="block py-2 pl-3 pr-4 font-normal rounded md:hover:bg-transparent md:hover:text-gold md:p-0 md:dark:hover:text-gold dark:hover:text-white md:dark:hover:bg-transparent"
              >จำนำ
            </MenuLink>
          </li>
          <li>
...
<nav class="bg-white w-full border-b border-b-gold sticky top-0 left-0 z-20">
  ...
  <div class="flex items-center md:order-2">
      <button type="button" class="flex mr-3 text-sm bg-gray-800 rounded-full md:mr-0 focus:ring-4 focus:ring-gray-300 " id="user-menu-button" aria-expanded="false" data-dropdown-toggle="user-dropdown" data-dropdown-placement="bottom">
        ...
        <img class="w-12 h-12 rounded-full object-fit border-2 border-gold" src="@/assets/images/team/ping.png" alt="user photo">
      </button>
      <!-- Dropdown menu -->
      <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow " id="user-dropdown">
        ...
        <ul class="py-2" aria-labelledby="user-menu-button">
          <li>
            <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 font-light ">เมนูทั้งหมด</a>
          </li>
          <li>
