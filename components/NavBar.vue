  ...
  <nav v-if="!isLogin" class="bg-white w-full border-b border-b-gold sticky top-0 left-0 z-20 font-kanit">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
      <MenuLink to="/" class="flex items-center">
        ...
        <span class="self-center text-2xl font-semibold whitespace-nowrap"><span class="text-gold">G</span>olden
          <span class="text-gold">T</span>iara</span>
      </MenuLink>
      <div class="md:order-2 md:pl-20">
        <MenuLink to="/auth/login" type="button"
      ...
      <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1 md:ml-5" id="navbar-sticky">
        <ul
    ...
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
      ...
      <div class="flex items-center md:order-2">
        <button type="button" class="flex mr-3 text-sm bg-gray-800 rounded-full md:mr-0 focus:ring-4 focus:ring-gray-300"
          ...
          <img class="w-10 h-10 rounded-full" :src="`http://localhost/images/gold/${imagePath}`" alt="user photo" />
        </button>
        ...
        <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow"
          ...
          <ul class="py-2" aria-labelledby="user-menu-button">
            <li v-if="role == 'customer'">
              <MenuLink class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">dfgfggdg</MenuLink>
            </li>
            <li v-if="role == 'owner && seller'">
              <MenuLink to="/gold" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">gold</MenuLink>
            </li>
            <li>
              <MenuLink href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Settings</MenuLink>
            </li>
            <li>
              <MenuLink href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Earnings</MenuLink>
            </li>
            <li>
              <MenuLink @click="logout" class="block px-4 py-2 text-sm hover:bg-gray-100 text-red-500 cursor-pointer">
                ออกจากระบบ</MenuLink>
            </li>
          </ul>
        </div>
