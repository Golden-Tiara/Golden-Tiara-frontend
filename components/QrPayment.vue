  ...
  >
    <div class="relative w-full max-w-md max-h-full">
      <div class="relative bg-white rounded-lg shadow py-7">
        ...
        >
          <svg class="h-10 w-10 animate-spin stroke-gold" viewBox="0 0 256 256">
            <line
              x1="128"
              y1="32"
              x2="128"
          ...
          <span class="text-xl ml-2 font-medium text-gray-500 text-center"
            >please wait for<br />
            verified the payment</span
          >
        </div>
      </div>
    </div>
